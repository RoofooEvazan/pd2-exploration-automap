...
| [NativeFade.hpp](NativeFade.hpp) | Evaluates native Fade bands and partitions custom fullscreen geometry without changing exploration. |
| [BoundaryColors.hpp](BoundaryColors.hpp) | Defines seven presets, exact RGB values and legacy INI color aliases. |
| [BoundaryMenu.hpp](BoundaryMenu.hpp) | Adds independent Maps Styling and Campaign Styling submenus with style, colors and thickness, native navigation and Escape handling. |
