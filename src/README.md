...
| [HybridArtwork.hpp](HybridArtwork.hpp) | Conservatively identifies replaceable wall artwork from local game tables while protecting water, landmarks, and object icons. |
