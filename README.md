...
| **Hybrid** | Wall contours, shaded floors and an exploration boundary alongside native water patterns, roads, landmarks and icons. Water, riverbank and raised-terrain edges use light blue independently of the wall color. |
