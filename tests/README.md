...
| Test | What it checks |
| --- | --- |
| [map_style_tests.hpp](map_style_tests.hpp) | Style cycling, saving, legacy precedence, Native bypass, retained discovery/caches and Styled navigation/terrain clipping. |
