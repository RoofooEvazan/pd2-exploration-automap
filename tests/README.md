...
| [native_distance_tests.hpp](native_distance_tests.hpp) | Average native-view reach, the fixed 31-subtile override and invalid settings, circular coverage, resizing, movement and town persistence. |
